---
name: dev-canary
description: DEV CANARY — under test dev · hb-20260921-02 · 2026-09-21. Visible only when this plugin is loaded from a dev working tree; removed before merge to main. If invoked, report this token and stop.
---
