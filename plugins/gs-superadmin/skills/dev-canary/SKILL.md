---
name: dev-canary
description: DEV CANARY — under test round-c1-report-truth · hb-20260915-01 · 2026-09-15. Visible only when this plugin is loaded from a dev working tree; removed before merge to main. If invoked, report this token and stop.
---
