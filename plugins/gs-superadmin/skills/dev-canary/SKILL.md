---
name: dev-canary
description: DEV CANARY — under test round-b-describe-loop · hb-20260914-01 · 2026-09-14. Visible only when this plugin is loaded from a dev working tree; removed before merge to main. If invoked, report this token and stop.
---
