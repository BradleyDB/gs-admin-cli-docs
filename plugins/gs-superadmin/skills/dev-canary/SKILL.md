---
name: dev-canary
description: DEV CANARY — under test round-e-guard-normalizer · hb-20260916-02 · 2026-09-16. Visible only when this plugin is loaded from a dev working tree; removed before merge to main. If invoked, report this token and stop.
---
