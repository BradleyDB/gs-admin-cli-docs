---
name: dev-canary
description: DEV CANARY — under test dev · hb-20260916-03 · 2026-09-16. Visible only when this plugin is loaded from a dev working tree; removed before merge to main. If invoked, report this token and stop.
---
